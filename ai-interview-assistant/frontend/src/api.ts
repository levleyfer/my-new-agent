...
export const getQuestions = (params?: { category?: string; difficulty?: string; limit?: number; offset?: number }) =>
...
export const getAnalyticsWeaknesses = () =>
  api.get("/analytics/weaknesses").then((r) => r.data);

export const getAnalyticsFillerWords = () =>
  api.get("/analytics/filler-words").then((r) => r.data);
